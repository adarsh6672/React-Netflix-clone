...
const Signup = () => {
  ...
  return (
    ...
    <div className='w-full h-screen'>
        <img className='hidden sm:block absolute w-full object-cover' src="https://static.standard.co.uk/2022/11/16/10/netflix-s.jpg?crop=8:5,smart&quality=75&auto=webp&width=1024" alt="" />
                ...
                <div className='max-w-[320px] mx-auto py-16'>
                    ...
                    <form onSubmit={handleSubmit} className='w-full flex flex-col py-4'>
                        <input onChange={(e)=> setEmail(e.target.value)}
                         ...
                         type='email' placeholder='email' autoComplete='email'></input>
